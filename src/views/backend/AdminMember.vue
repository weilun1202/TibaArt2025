...
const columns = [
  ...
  { key: 'email', label: 'Email', class:'w-300'},
  { key: 'phone', label: '連絡電話', class: 'w-150'},
  { key: 'register', label: '註冊時間', class: 'w-200' },
  { key: 'update', label: '修改時間' , class: 'w-200'},
  { key: 'status', label: '狀態', type:'switch', class: 'w-100' },
  { key: 'more', label: '詳細', type: 'button', buttonLabel: '查看', class: 'w-100' }
]
