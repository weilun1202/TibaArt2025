    ...
    <div>
        ...
        <div class="wrap">
            ...
            <section>
                ...
                <h5>本網站絕不會提供、交換、出租或出售任何您的個人資料給其他個人、團體、私人企業或公務機關，但有法律依據或合約義務者，不在此限。<br><br>
                前項但書之情形包括不限於：</h5>
                <ul>
                    <li>經由您書面同意。</li>
                    <li>法律明文規定。</li>
                ...
                <h5><br>本網站委託廠商協助蒐集、處理或利用您的個人資料時，將對委外廠商或個人善盡監督管理之責。</h5>
            </section>
        
            <section>
                <h4>六、Cookie之使用</h4>
                <h5>為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的Cookie，若您不願接受Cookie的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕Cookie的寫入，但可能會導至網站某些功能無法正常執行。</h5>
            </section>
            
            <section>
                <h4>七、隱私權保護政策之修正</h4>
                <h5>本網站隱私權保護政策將因應需求隨時進行修正，修正後的條款將刊登於網站上。</h5>
            </section>

            <section>
                <h4>八、聯繫管道</h4>
                <h5>對於本站之隱私權政策有任何疑問，或者想提出變更、移除個人資料之請求，請前往本站「聯絡我們」頁面提交表單。或藉由以下資訊聯繫我們:<br>
                公司名稱: 緯藝基金會 TibaArt<br>
                Email: tibaart101@mail.tw<br>
                電話: 02-12345678<br>
                </h5>
            </section>                   
        </div>     
